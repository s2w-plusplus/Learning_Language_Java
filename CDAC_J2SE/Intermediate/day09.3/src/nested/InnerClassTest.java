...
class Outer1 {
	...
	static void test1() {
	// Outer1 class's static member cant access/instantiate Inner class in any way. 
	// so cant access its instance members.
	//for this u 1st have to instantiate Outer1 class then inner class.
		System.out.println("static Outer1 member :invoking non-static member of the inner class : after creating an instance");
	...
	class Inner {
		...
		void display() {
		// non-static member of Inner class : can access directly both static/non-static members of the Outer1 class.
