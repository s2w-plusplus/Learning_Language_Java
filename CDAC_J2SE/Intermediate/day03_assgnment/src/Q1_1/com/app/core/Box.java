...
public class Box {
    ...
    public String getBoxDetails() {
        ...
        return "Dimensions W:" + width + " L:" + depth + " H:" + height + " Vol:"+this.getBoxVolume();
    }
    
    public double getBwidth()//setter method added by saurabh 
    {
    	return width;
    }
    public void setBwidth(double width)//setter method added by saurabh 
    {
    	this.width=width;
    }
