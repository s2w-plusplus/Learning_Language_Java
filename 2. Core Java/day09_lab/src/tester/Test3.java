...
public class Test3 {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			...
			Vehicle[] vehicleArr = new Vehicle[sc.nextInt()];// 100 : only 1 array obj is created
			boolean exit = false;
			int counter = 0;
			while (!exit) {
				...
				try {
					...
					case 1: // add boundary chking here....
						if (counter < vehicleArr.length) {
							...
							throw new VehicleHandlingException("Warehouse capacity full!!!!!");
						break;
					case 2:
